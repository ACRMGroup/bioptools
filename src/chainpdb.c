/*************************************************************************
   ...
   Version:    V1.6
   Date:       30.05.02
   Function:   Insert chain labels into a PDB file
   
   Copyright:  (c) Dr. Andrew C. R. Martin 1994-2002
...
/*>BOOL ParseCmdLine(int argc, char **argv, char *infile, char *outfile, 
   ...
   Output:  char   *infile          Input filename (or blank string)
            ...
            BOOL   *BumpChainOnHet  Bump chain label on ATOMs after HETs
...
void Usage(void)
{
   fprintf(stderr,"\nChainPDB V1.6 (c) 1994-2002 Dr. Andrew C.R. Martin, \
UCL\n");
...
/*>void DoChain(PDB *pdb, char *chains, BOOL BumpChainOnHet)
   ...
   Input:   char   *chains         Chain labels (or blank string)
