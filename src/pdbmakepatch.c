...
/**
   ...
   \copyright  (c) UCL / Dr. Andrew C. R. Martin 2009-2017
...
-  V1.12 21.11.17  Updated usage to explain use with pdbsolv
...
void Usage(void)
{
   fprintf(stderr,"\npdbmakepatch V1.12 Andrew C.R. Martin, Anja \
Baresic, UCL 2009-2017\n");
...
file can be\n");
   fprintf(stderr,"generated by running 'pdbsolv -x' on a PDB file or \
by using as2bval on\n");
   fprintf(stderr,"the .asa file produced by NACCESS.\n");

   fprintf(stderr,"\nThe program requires a residue and atom on the \
